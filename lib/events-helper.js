...
export function convertToDevType(value) {
...
export function convertToFase(value) {
...
export function convertToErogResult(value) {
    const matchingState = Object.keys(ErogResult).find(key => ErogResult[key].value === value);
    return matchingState || "undefined";
};

export const MotMoveRequest = {      // NON PORTABILE (riflette codici sharedMem)
        Stop: { value: 0 },
        Allinea: { value: 1 },
...
export function convertToMotMoveRequest(value) {
    const matchingState = Object.keys(MotMoveRequest).find(key => MotMoveRequest[key].value === value);
    return matchingState || "undefined";
};

export function translateFrigoState(element) {
