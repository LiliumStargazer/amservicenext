import {calculateDaysBetweenDates} from "@/features/shared/client/utils/utils";
...
export const filterTicketsAndAddTTR = (tickets: any[], activeTechnicians: string[], isOpen: boolean): Ticket[] => {
