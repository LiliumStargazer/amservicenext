    ...
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content bottom-0 w-full"
            ...
            <aside className="items-center grid-flow-col">
                ...
                <p>© AM Automatic Machines SRL a Socio Unico
                    Via Brunelleschi, 1 – 25010 San Zeno Naviglio, Brescia (Italy)
                    P.IVA 03513890172 – REA: BS-410627 – Capitale sociale versato: 100.000,00 €</p>
            </aside>
