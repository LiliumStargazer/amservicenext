...
export class DatabasePathOld {
    ...
    protected readonly _remoteOutDir: string | undefined;
    protected readonly _remoteUploadFileName: string;
    protected readonly _remoteUploadBackupWithFingerFileName: string | undefined;
    protected readonly _remoteDb: string | undefined;
    protected readonly _remoteOutPath: string | undefined;
    protected readonly _remoteOutFileName: string | undefined;
    ...
    protected readonly _localBackupWithFingerZippedDb: string | undefined;
    ...
    constructor(private matricola: string, private backupName: string | undefined) {
        ...
        if (this.backupName !== undefined) {
            ...
            this._localRecoveredZippedDb = path.join(this._localDirectory, this.BACKUP_ZIP);
            this._localBackupWithFingerZippedDb = path.join(this._localDirectory, this.BACKUP_WITH_FINGER_ZIP);
    ...
    get remoteUploadPathFile(): string {
        return path.join(this.matricola, this.UPDATE_DIR, this.BACKUP_ZIP);
    }
