...
import DialogPassword from "@/app/components/navbar/DialogPassword";
...
/*           <div className="drawer">
            <input id="my-drawer" type="checkbox" className="drawer-toggle" />
                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4 z-index-99">
        
                    <li><a>Sidebar Item 1</a></li>
                    <li><a>Sidebar Item 2</a></li>
                    </ul>
                </div>
            </div> */ // cambiare con un drawer a sinistra
