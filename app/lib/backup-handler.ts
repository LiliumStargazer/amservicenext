...
//     const remoteConfigDir = path.join(matricola, CONFIG_DIRECTORY).toString();
...
// // }
//
// // async function executeQueryOnDb<T>(sqliteDbPath: string, query: string): Promise<T[]> {
// //     try {
...
// }
//
// // export { unzipFile, executeQueryOnDb, createDirectory, createSystemPaths, setLocalBackupUnzippedFile };
// export { createDirectory, createSystemPaths, setLocalBackupUnzippedFile };